package com.downloader.downloader;


/**
 * @description: 下载bilibili视频
 * @author: wangning
 * @create: 2022-12-02 18:47
 **/
...
public class DownLoader {
    /** 视频地址 */
    private static String VIDEO_URL = "https://www.bilibili.com/video/BV1sx411X7af/?spm_id_from=333.337.search-card.all.click&vd_source=4b530215876ba7eb60c88a66ca38913f";
    /** FFMPEG位置 `windows电脑下是ffmpeg.exe`*/
//    private static String FFMPEG_PATH = "/Users/xiuming/Desktop/test/ffmpeg/bin/ffmpeg";
    private static String FFMPEG_PATH = "D:/ffmpeg-release-essentials/ffmpeg-4.3.1-2021-01-01-essentials_build/bin/ffmpeg.exe";
